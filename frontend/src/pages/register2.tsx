                ...
                <div className='register2'>
                    ...
                    <div className='addCard' onClick={handleAddClick}>
                        <div className='addIcon' id='addIcon'>
                            { previewUrl ? (<img src={ previewUrl } alt='Твоя аватарка'/>) : (<svg width="200" height="200" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <form className='addForm' onSubmit={(e) => {
                        ...
                        <div className='addInputs'>
                            <input placeholder='Отображаемое имя' onChange={(e) => {setName(e.target.value)}} />
                            <input placeholder='Описание' onChange={(e) => {setBio(e.target.value)}} />
                        </div>
                        <button type='submit' />
                    </form>
                </div>
